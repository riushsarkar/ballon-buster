...
function blueBalloon() {
  ...
  blueballoon = createSprite(0,Math,round(20,370),10,10)
...
function greenBalloon() {
  ...
  greenballoon = createSprite(0,Math,round(20,370),10,10)
  greenballoon.addImage(blue_balloonImage);
...
function pinkBalloon() {
  ...
  pinkballoon = createSprite(0,Math,round(20,370),10,10)
  pinkballoon.addImage(blue_balloonImage);
